...
public LiveData<List<Pago>> getPagos(){
    ...
    public void obtenerPropiedades(){
        ...
        lista.add(new Propiedad(2, "Poblet 548", 10, "Depto", "Comercial", 85,50000, true,5016));
        lista.add(new Propiedad(3, "Bolivar 815", 1, "Depto", "Comercial", 85,5000, true,5016));
        lista.add(new Propiedad(4, "Colon 3213", 3, "Depto", "Residencial",85, 15000, true,5016));
        ...
        lista.add(new Propiedad(8, "Ruta 20 km 4", 3, "Depto", "Residencial",85, 15000, true,5016));
