...
public class ContratoViewModel extends ViewModel {
    ...
    public void obtenerPropiedades(){
        ...
        lista.add(new Propiedad(2, "Poblet 548", 10, "Depto", "Comercial", 75,50000, true));
        lista.add(new Propiedad(3, "Bolivar 815", 1, "Depto", "Comercial", 65,5000, true));
        lista.add(new Propiedad(4, "Colon 3213", 3, "Depto", "Residencial",95, 15000, true));
        lista.add(new Propiedad(5, "Lince 22 19", 6, "Depto", "Comercial", 78,30000, true));
        lista.add(new Propiedad(6, "Italia 11 Sur", 2, "Depto", "Comercial", 94,10000, true));
        lista.add(new Propiedad(7, "Ruta 3 Km 11", 8, "Depto", "Residencial", 80,80000, true));
        lista.add(new Propiedad(8, "Ruta 20 km 4", 3, "Depto", "Residencial", 45,15000, true));
        lista.add(new Propiedad(9, "Av Illia 185", 4, "Depto", "Comercial", 46,20000, true));
